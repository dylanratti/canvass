  ...
  return (
    <div style={{ background: 'var(--cream)' }}>
      ...
      <nav style={{ position: 'sticky', top: 0, zIndex: 100, background: 'rgba(250,250,247,0.92)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', borderBottom: '1px solid var(--border)' }}>
        <div style={{ maxWidth: '1120px', margin: '0 auto', padding: '0 48px', height: '64px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      ...
      {/* HERO */}
      <section style={{ maxWidth: '1120px', margin: '0 auto', padding: '80px 48px 60px' }}>

        {/* Headline */}
        <div style={{ maxWidth: '680px', marginBottom: '72px' }}>
          <h1 style={{ ...display, fontSize: 'clamp(3rem, 6vw, 5.2rem)', lineHeight: 1.05, letterSpacing: '0.01em', color: 'var(--ink)', marginBottom: '24px' }}>
            Know if your ad lands<br />
            <span style={{ color: 'var(--terra)', fontStyle: 'normal' }}>before you pay for it.</span>
          </h1>
          <p style={{ ...w(300), fontSize: '1.1rem', lineHeight: 1.75, color: 'var(--ink-2)', maxWidth: '500px', marginBottom: '36px' }}>
        ...
        {/* Stats */}
        <div style={{ marginTop: '72px', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', borderTop: '1px solid var(--border)' }}>
          {[
            ...
            <div key={i} style={{ padding: '32px 0', paddingRight: '24px', borderRight: i < 2 ? '1px solid var(--border)' : 'none', paddingLeft: i > 0 ? '32px' : '0' }}>
      ...
      {/* HOW IT WORKS */}
      <section style={{ maxWidth: '1120px', margin: '0 auto', padding: '100px 48px' }}>
        <SR>
          ...
          <h2 style={{ ...display, fontSize: 'clamp(1.8rem, 3.5vw, 3rem)', lineHeight: 1.1, letterSpacing: '0.01em', color: 'var(--ink)', marginBottom: '64px', maxWidth: '440px' }}>
          ...
          {[
            ...
            <SR key={i} delay={i * 100}>
              <div style={{ background: 'var(--cream)', padding: '44px 40px', height: '100%' }}>
                ...
                <h3 style={{ ...w(500), fontSize: '1.05rem', color: 'var(--ink)', marginBottom: '12px', lineHeight: 1.4, letterSpacing: '0.01em' }}>{step.title}</h3>
      ...
      <section style={{ background: 'var(--ink)', padding: '100px 48px' }}>
        <div style={{ maxWidth: '1120px', margin: '0 auto' }}>
          <SR>
            ...
            <h2 style={{ ...display, fontSize: 'clamp(2rem, 4vw, 3.2rem)', lineHeight: 1.1, letterSpacing: '0.01em', color: 'var(--cream)', marginBottom: '18px', maxWidth: '620px' }}>
              Every channel lets you test before you scale. Except one.
            </h2>
            <p style={{ ...w(300), fontSize: '1rem', color: 'rgba(250,250,247,0.45)', lineHeight: 1.8, maxWidth: '480px', marginBottom: '72px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
            {[
              {
                val: '#1',
                label: 'OOH has the highest ad recall of any media channel',
                sub: 'Higher than TV, streaming, social, radio, and print — per a 2023 Solomon Partners analysis of 5 years of data.',
                src: 'Solomon Partners / OAAA, 2023'
              },
              {
                val: '$6',
                label: 'In product sales generated per $1 spent on OOH',
                sub: "The medium with the best ROI that you can't A/B test before committing. Until now.",
                src: 'Vistar Media, 2024'
              },
              {
                val: '46%',
                label: 'Of consumers search for a brand after seeing an OOH ad',
                sub: "It drives digital action at scale — but only if the creative actually lands with the people who see it.",
                src: 'One Day Agency / OAAA'
              },
            ].map((item, i) => (
              <SR key={i} delay={i * 80}>
                <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '32px 28px', height: '100%', display: 'flex', flexDirection: 'column' }}>
                  <div style={{ ...display, fontSize: 'clamp(2.2rem, 3.5vw, 3rem)', color: 'var(--terra)', lineHeight: 1, marginBottom: '14px' }}>{item.val}</div>
                  ...
                  <div style={{ marginTop: '16px', paddingTop: '14px', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
                    <span style={{ ...w(300), fontSize: '0.66rem', color: 'rgba(250,250,247,0.2)', letterSpacing: '0.03em' }}>{item.src}</span>
                  </div>
                </div>
              </SR>
            ))}
      ...
      <section style={{ maxWidth: '1120px', margin: '0 auto', padding: '100px 48px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '80px', alignItems: 'start' }}>
          <SR>
            ...
            <h2 style={{ ...display, fontSize: 'clamp(1.8rem, 3vw, 2.6rem)', lineHeight: 1.1, letterSpacing: '0.01em', color: 'var(--ink)', marginBottom: '22px' }}>
            ...
            <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
              ...
              <div style={{ padding: '28px 24px' }}>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: '10px', marginBottom: '32px' }}>
                  <span style={{ ...display, fontSize: '3.5rem', color: 'var(--ink)', lineHeight: 1 }}>92%</span>
                ...
                <div style={{ borderTop: '1px solid var(--border)', paddingTop: '14px', marginTop: '4px' }}>
                  <span style={{ ...w(300), fontSize: '0.72rem', color: 'var(--ink-4)' }}>Panel n=340 · Kantar syndicated study · Oct 2024</span>
                </div>
              </div>
            </div>
          </SR>
      ...
      {/* AGENTS */}
      <section style={{ background: 'var(--white)', borderTop: '1px solid var(--border)', padding: '100px 48px' }}>
        <div style={{ maxWidth: '1120px', margin: '0 auto' }}>
          <SR>
            ...
            <h2 style={{ ...display, fontSize: 'clamp(1.8rem, 3.5vw, 3rem)', lineHeight: 1.1, letterSpacing: '0.01em', color: 'var(--ink)', marginBottom: '14px', maxWidth: '420px' }}>
              Not averages.<br />Individuals.
            </h2>
            <p style={{ ...w(300), fontSize: '0.92rem', color: 'var(--ink-2)', marginBottom: '56px', maxWidth: '440px', lineHeight: 1.75 }}>Each agent layers demographic, behavioral, and psychographic data. They respond the way real people in that segment actually would.</p>
          </SR>
            ...
            {AGENTS.map((a, i) => (
              <SR key={i} delay={i * 80}>
                <div className="card" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                  ...
                  <div style={{ ...w(300), fontSize: '0.78rem', color: 'var(--ink-2)', marginBottom: '16px' }}>{a.income} HHI</div>
          ...
          <SR delay={200}><p style={{ ...w(300), textAlign: 'center', fontSize: '0.8rem', color: 'var(--ink-3)', marginTop: '28px' }}>+ 400 more profiles across 38 US metros and 12 international markets</p></SR>
        </div>
      </section>

      {/* CTA */}
      <section id="waitlist" style={{ padding: '120px 48px', background: 'var(--cream)', borderTop: '1px solid var(--border)' }}>
        <SR>
          <div style={{ maxWidth: '540px', margin: '0 auto', textAlign: 'center' }}>
            <h2 style={{ ...display, fontSize: 'clamp(2.5rem, 6vw, 4.5rem)', lineHeight: 1.05, letterSpacing: '0.01em', color: 'var(--ink)', marginBottom: '18px' }}>
              Stop guessing.<br />
              <span style={{ color: 'var(--terra)' }}>Start knowing.</span>
            </h2>
            <p style={{ ...w(300), fontSize: '0.95rem', color: 'var(--ink-2)', lineHeight: 1.8, marginBottom: '40px' }}>First 100 brands get founding pricing, direct team access, and input into which demographic agents we build first.</p>
